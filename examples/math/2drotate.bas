...
type obj_struct
	...
	vertices        as vector2d ptr 'the vertex array
	tvertices       as vector2d ptr 'secondary array for transformed vertices
...
obj.vertices  = new vector2d[obj.max_vertices]
obj.tvertices = new vector2d[obj.max_vertices]
...
for i as integer = 0 to obj.max_vertices-1
	...
	obj.vertices[i] = vector2d(tx,ty) * init_matrix
next
...
dim as vector2d position = vector2d(320, 240)'the position vector for the ship
dim as vector2d velocity'the velocity(direction) vector of the ship
...
do
	...
	for l as integer = 0 to obj.max_lines-1
		dim as vector2d p1 = obj.tvertices[ obj.lines[l].index(1) ]
		dim as vector2d p2 = obj.tvertices[ obj.lines[l].index(2) ]
