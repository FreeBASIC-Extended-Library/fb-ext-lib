...
namespace ext.gfx
    ...
    declare sub TriangleASM( byval dst as FB.IMAGE ptr = 0, byref p1 as ext.math.vector2d, byref p2 as ext.math.vector2d, byref p3 as ext.math.vector2d, byval col as uinteger = rgba(255,255,255,255) )
