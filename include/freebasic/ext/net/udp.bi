...
#ifndef FBEXT_NET_udp_BI__
#define FBEXT_NET_udp_BI__ -1
...
''the User Datagram Protocol. Allows creation of both server
''and client sockets.
''
type udpSocket
        ...
        ''
        #macro fbext_udpSocketGet_Declare(T_)
        ...
        ''True if succesful
        ''
        #macro fbext_udpSocketPut_Declare(T_)
