...
# pragma once
# ifndef FBEXT_INCLUDED_PP_CAT_BI__
# define FBEXT_INCLUDED_PP_CAT_BI__ -1

'' ##### FBEXT_PP_CAT

# define FBEXT_PP_CAT(a, b) a##b
# define fbextPP_Cat(a, b) a##b
