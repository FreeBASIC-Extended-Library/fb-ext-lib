...
type Connection
	...
	''Initializes a connection to a database using a connection string
	''and a <ext.database.DatabaseDriver>.
	''
	''Parameters:
	''connectst - a database dependant connection string.
	''d - a pointer to a <ext.database.DatabaseDriver>
	declare constructor( byref connectst as string, byval d as DatabaseDriver ptr )

	''Sub: Component Constructor
	''Initializes a database connection with only a <ext.database.DatabaseDriver>.
	''You must pass a connection string to the <connect> function.
	''
	''Parameters:
	''d - a pointer to a <ext.database.DatabaseDriver>
	...
	''Function: connect
	''Connects to the database using the passed connection string or the
	''connection string passed to the constructor.
	''
	''Parameters:
