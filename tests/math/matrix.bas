...
namespace ext.tests.math
	...
	private function check_vector ( byref v as ext.math.vector3d, byval x as single, byval y as single, byval z as single) as bool
	...
	private sub test_matrix_invert
		...
		var m = matrix( _
			type<vector3d>( 0.0f, 1.0f, 2.0f ), _
			type<vector3d>( 3.0f, 4.0f, 5.0f ), _
			type<vector3d>( 6.0f, 7.0f, 8.0f ), _
			type<vector3d>( 9.0f, 10.0f, 11.0f ) _
		)
		m.invert()
