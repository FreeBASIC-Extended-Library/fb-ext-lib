...
namespace ext.tests.hashes
	...
	''Invalid
	ext_assert_STRING_EQUAL( "Invalid key length", ext.hashes.sha2( "doesn't matter", 42 ) )

	''224
	ext_assert_STRING_EQUAL( "23097d223405d8228642a477bda255b32aadbce4bda0b3f7e36c9da7", ext.hashes.sha2( "abc", 224 ) )
	...
	''384
	ext_assert_STRING_EQUAL( "38b060a751ac96384cd9327eb1b1e36a21fdb71114be07434c0cc7bf63f6e1da274edebfe76f65fbd51ad2f14898b95b", ext.hashes.sha2( "", 384 ) )
	ext_assert_STRING_EQUAL( "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7", ext.hashes.sha2( "abc", 384 ) )
	''512
	ext_assert_STRING_EQUAL( "ee180b331ce6100da9ee3be145f57281b9a0bad185be319c4b30a10ceaf0a8e17d7b0c74aa7c71db46d50b2c051dc9f02177f392f17442c0eb088801ee78fe6a", ext.hashes.sha2( FBEXT_TEST_STRING, 512 ) )
	ext_assert_STRING_EQUAL( "cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3e", ext.hashes.sha2( "", 512 ) )
	ext_assert_STRING_EQUAL( "ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f", ext.hashes.sha2( "abc", 512 ) )
	end sub
